...
export class DynamicAliasResolvePlugin {
  /**
   *
   ...
   */
  constructor({ alias, dynamic, pattern } = {}) {
  ...
  apply(resolver) {
    ...
    resolver.getHook('described-resolve').tapAsync('DynamicAliasResolvePlugin', (request, resolveContext, callback) => {
      /**
       * @type {string}
       */
